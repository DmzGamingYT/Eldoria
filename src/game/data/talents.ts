...
export const TALENTS: TalentDef[] = [
  ...
  },
  {
    ...
    tier: 5,
    nameFr: "Bourreau",
    descFr: "Vos critiques frappent ×2.5 au lieu de ×2. +5% critiques.",
    icon: "👑",
    cost: 2,
  ...
  },
  {
    ...
    tier: 5,
    nameFr: "Archimage",
    descFr: "Maîtrise totale : +35% de puissance, +50 Mana max.",
    icon: "👑",
    cost: 2,
    prerequisites: { branchPoints: 5 },
  ...
  },
  {
    ...
    tier: 5,
    nameFr: "Immortel",
    descFr: "Renaissance perpétuelle : +5 HP/sec, +5 Défense.",
    icon: "👑",
    cost: 2,
    prerequisites: { branchPoints: 5 },
