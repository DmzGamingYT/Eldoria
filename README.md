...
<img src="public/banner/commandes-hero.svg" alt="Contrôles du héros Eldoria — WASD pour se déplacer, Maj pour courir, Espace/J pour attaquer, [/] pour tourner la caméra, E/I/Q/C/H pour interagir (PNJ, inventaire, journal, fiche, aide), 1/2/3 barre rapide potions" width="100%" style="max-width:900px">
...
<p align="center"><strong>❦ 13 piliers · 1 cathédrale · 1 seul dépôt ❦</strong></p>

<p align="center"><em>❦ Du <strong>monde 3D</strong> au <strong>cœur du joueur</strong>, chaque pilier tisse sa légende, sa quête, sa mécanique. Le royaume n'est pas un assemblage — c'est une cathédrale pensée comme un seul dépôt.</em></p>
...
>
> **Légende :** ✅ Fonctionnel · ⚠️ Problème connu · ❌ Non testé
...
<p align="center">
  <a href="public/banner/architecture-hero.svg">
    <img src="public/banner/architecture-hero.svg"
         alt="Architecture technique en sept couches d'Eldoria — HÔTES (navigateur + Electron), SHELL WEB (Next.js 16 + /API + APP/GAME), RENDU 3D (React + R3F + Three.js + drei + post-fx), MOTEUR JEU (Game.tsx orchestrateur avec bordure rouge), ÉTAT GLOBAL (Zustand + types + audio), MODULES (player + enemies + world + effects + ui + data), PERSISTANCE & ASSETS (Prisma+SQLite + Quaternius CC0 + banners SVG cinématiques + scripts). Flèches pulsantes en or entre chaque couche."
         width="100%" style="max-width:1300px; display:block; border-radius:3px;">
  </a>
</p>

<p align="center"><strong>❦ Sept strates, une cathédrale, un seul royaume ❦</strong></p>
